var days = ["اتوار", "پیر", "منگل", "بدھ", "جمعرات", "جمعه", "ہفتہ"];
...
let timer = function () {
    return new Promise(function (resolve, reject) {
        ...
        console.log(cMonth)
        fetch(`https://api.aladhan.com/v1/calendar?latitude=24.946218&longitude=67.005615&method=2&month=${cMonth+1}&year=2018`)
